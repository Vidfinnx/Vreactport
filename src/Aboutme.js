    ...
    return (
        <div>
            ...
            <Image src={AhoBG} fluid />
                {/* <Row> */}
                <Col style={{borderRadius: '20px', fontFamily: 'Digital', backgroundColor: 'black', color: 'Limegreen'}}><span style={{color: 'yellow'}}>Knowledgeable In:</span> React, Javascript, Node, GraphQL, Jquery, React-Native, Mongo-DB, MySQL, HandlebarsJS, HTML, CSS </Col>
                <br></br>
